...
const filesToWatch = [`markup/pages/**/*.${tars.templater.ext}`, `markup/${tars.config.fs.componentsFolderName}/**/*.${tars.templater.ext}`];
...
module.exports = () => {
    return tars
        .packages
        .chokidar
        .watch(filesToWatch, Object.assign(tars.options.watch, {ignored: `markup/pages/**/_*.${tars.templater.ext}`}))
